...
library("factorcpt")
###functions
simulation_setting = function(sigma1,m,p,R,omega,n,signal,mu=0,sigma=1){
  Theta<-matrix(rnorm(m*p, 0, sigma1),m,p)
  Theta_SVD<-svd(Theta)
...
for (Iter in 1:Itermax){
  ...
  X2=simulation_setting(1.5,m,p,R1,omega,T2,signal)[[1]]
  Y2=simulation_setting(1.5,m,p,R1,omega,T2,signal)[[2]]
  
  
  X3=simulation_setting(2,m,p,R1,omega,T3,signal)[[1]]
  Y3=simulation_setting(2,m,p,R1,omega,T3,signal)[[2]]
  
  X4=simulation_setting(1,m,p,R1,omega,T4,signal)[[1]]
  Y4=simulation_setting(1,m,p,R1,omega,T4,signal)[[2]]
  
  X5=simulation_setting(1.5,m,p,R1,omega,T5,signal)[[1]]
  Y5=simulation_setting(1.5,m,p,R1,omega,T5,signal)[[2]]
...
save(list=ls(all=TRUE),file="cptcovLN.Rdata")