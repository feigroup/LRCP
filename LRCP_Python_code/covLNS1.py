...
def simu(sigma1,m,p,R,omega,T,signal,mu,sigma):
...
for Iter in range(Itermax):
    ...
    X2,Y2=simu(1.5,m,p,R1,omega,T2,signal,0,1)
    X3,Y3=simu(2,m,p,R1,omega,T3,signal,0,1)
    X4,Y4=simu(1,m,p,R1,omega,T4,signal,0,1)
    X5,Y5=simu(1.5,m,p,R1,omega,T5,signal,0,1)
...
np.save('MULcovLNcpt_num1',cpt_num)
np.save('MULcovLNd_under1',d_under)
np.save('MULcovLNd_over1',d_over)
